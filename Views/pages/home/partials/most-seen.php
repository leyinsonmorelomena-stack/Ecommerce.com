                ...
                <div class="clearfix">
                    ...
                    <span class="float-end">
                        <div class="btn-group btn-group-sm">
                            ...
                            <button class="btn btn-light border"><i class="fas fa-eye"></i></button>
                        </div>
                    </span>
                </div>
            </div>
            ...
            <div class="media border-bottom px-3 pt-4 pb-3 pb-lg-2">
                ...
                <div class="media-body ps-3">
                    ...
                    <div class="clearfix">
                        ...
                        <span class="float-end">
                            <div class="btn-group btn-group-sm">
                                <button type="button" class="btn btn-light border"><i class="fas fa-heart"></i></button>
                                <button type="button" class="btn btn-light border"><i class="fas fa-eye"></i></button>
                            </div>
                        </span>
                    </div>
                </div>
